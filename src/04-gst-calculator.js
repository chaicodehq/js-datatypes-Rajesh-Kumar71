...
export function calculateGST(amount, category) {
  // Your code here
  if (!Number.isFinite(amount) || amount <= 0 || typeof category !== "string" || category.trim().length === 0){return null;}
  ...
  if (!Object.prototype.hasOwnProperty.call(rates, lowerCategory)){return null;}

  if(!lowerCategory in rates){return null;}

  const rate = rates[lowerCategory];
